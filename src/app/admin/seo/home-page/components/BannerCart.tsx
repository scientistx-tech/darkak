...
const BannerTable = () => {
  ...
  return (
    <div className="overflow-x-auto bg-white dark:bg-dark rounded-md border p-4 shadow">
      ...
      <Modal title="Add New Banner" open={isModalOpen} onCancel={handleCancel} footer={null}>
        <BannerForm
          onSuccess={() => {

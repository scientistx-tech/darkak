...
export default function Page() {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${BASE_URL}/public/page-seo/home`) ///will cahnge type "home","about"
      .then((res) => {
  ...
  return (
    <div className="">
      <h1 className="mb-4 text-2xl font-bold">SEO Home Page</h1>
      <p className="mb-6 text-gray-700">Manage your SEO settings below.</p>
      ...
      <div className="rounded-lg border bg-white p-6 shadow">
        ...
        <div className="mb-6 flex flex-col gap-6 xl:flex-row">
          ...
          <div className="w-full xl:w-1/2">
            <label className="block font-medium text-gray-700">
              Meta Image <span className="text-sm text-gray-500">(Ratio 1:1 — 500x500px)</span>
            </label>
        ...
        <div className="mb-5">
          <label className="block font-medium text-gray-700">Alt Tag *</label>
          <input
            type="text"
            value={altTag}

...
const RestockRequestedProductList = () => {
  ...
  const { data, isLoading, error, refetch } =
    useGetVendorsRestockRequestedProductsQuery(queryParams);
  ...
  const [changeStatus] = useChangeVendorsProductRequestStatusMutation();
    ...
    <RequireAccess permission="product-list">
      <div className="min-h-screen">
        <h2 className="mb-4 flex items-center gap-2 text-xl font-bold">
          🏠 Restock Requested Product List{" "}
                    ...
                    <TableRow className="whitespace-nowrap" key={doc?.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-3">
                          <button
                            onClick={() => handleApproveProduct(doc?.id)}
                            className="rounded border border-blue-700 bg-blue-50 px-2 py-1 text-blue-700 hover:bg-blue-200"
                          >
                            <GiConfirmed className="mr-2 inline" />
                            Approve
                          </button>
                          <button
                            onClick={() => handleRejectProduct(doc?.id)}
                            className="rounded border border-rose-700 bg-rose-50 px-2 py-1 text-rose-700 hover:bg-red-200"
                          >
                            <GiCancel className="mr-2 inline" />
                            Reject
                          </button>
                        </div>
                      </TableCell>
...
export default RestockRequestedProductList;

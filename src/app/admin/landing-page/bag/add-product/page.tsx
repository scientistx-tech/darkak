...
import { useCreateBagProductMutation } from '../bag-slider/adminBagApis'; // ✅ Updated for bag
...
export default function AddProductPage() {
  ...
  const [createProduct] = useCreateBagProductMutation(); // ✅ Updated for bag
  ...
  const handleSubmit = async () => {
    if (!productId || !shortTitle || !thumbFile || !thumbAlt || !additionalFile || !additionalAlt || !type) {
    ...
    try {
      ...
      await createProduct(payload).unwrap(); // ✅ Now creates Bag product
  ...
  return (
    <div className="mt-6 w-full rounded-lg bg-white p-6 shadow-md">
      <h2 className="mb-6 text-2xl font-semibold text-gray-800">Add Bag Product Info</h2> {/* ✅ Changed title */}

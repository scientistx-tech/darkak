...
const [deleteProduct, { isLoading: isDeleting }] = useDeleteBagProductMutation();
 const token = useSelector((state: any) => state.auth.token);
const [changeStatus, { isLoading: isChangingStatus }] = useChangeBagProductStatusMutation();
                ...
                <TableRow key={product.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-3">
                      <Link
                        href={`/admin/landing-page/bag/product-list/${product.id}`}

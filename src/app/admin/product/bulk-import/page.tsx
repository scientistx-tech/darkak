...
export default function BulkImport() {
  return (
    <RequireAccess permission="bulk-product">
        ...
        <div className="">
          ...
          <div className="mb-6 rounded-xl bg-white p-6 shadow">
            ...
            <ol className="list-decimal space-y-2 pl-6 text-gray-700">
              ...
              <li>
                Once you have downloaded and filled the format file, Upload it
              ...
              <li>
                You can get brand and category id from their list please input
                the right ids.
              </li>
              <li>
                You can upload your product images in product folder from

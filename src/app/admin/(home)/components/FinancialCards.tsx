    ...
    <div className="mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="overflow-hidden rounded-lg bg-white shadow">
        <div className="p-4">
          ...
          <p className="mt-1 text-xs text-gray-500">In-House Earning</p>
        </div>
      </div>
      ...
      <div className="overflow-hidden rounded-lg bg-white shadow">
        <div className="p-4">
          ...
          <p className="mt-1 text-xs text-gray-500">Delivery Charge</p>
        </div>
      </div>
      ...
      <div className="overflow-hidden rounded-lg bg-white shadow">
        <div className="p-4">
          ...
          <p className="mt-1 text-xs text-gray-500">Pending Amount</p>
        </div>
      </div>
      ...
      <div className="overflow-hidden rounded-lg bg-white shadow">
        <div className="p-4">
          ...
          <p className="mt-1 text-xs text-gray-500">Total Tax</p>
        </div>
      </div>
    </div>
  );

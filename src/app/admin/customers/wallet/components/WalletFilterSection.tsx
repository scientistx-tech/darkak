...
const walletFilterSchema = Yup.object().shape({
  fromDate: Yup.string()
  ...
  customer: Yup.string()
    .oneOf(["All", "Devid Jack", "Tom Holland"], "Select a valid customer")
    .required("Customer is required"),
});
export const WalletFilterSection: React.FC = () => {
  ...
  const handleFilter = async () => {
    try {
      await walletFilterSchema.validate(formData, { abortEarly: false });

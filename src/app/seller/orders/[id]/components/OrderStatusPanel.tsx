...
} from "@/redux/services/seller/sellerOrderApis";
import { useGetAllCourierSellerQuery } from "@/redux/services/seller/sellerCourierApis";
...
export default function OrderStatusPanel({ orderDetails, refetch }: any) {
  ...
  const [changePaymentStatus] = useUpdatePaymentStatusSellerMutation();
  const {
    data,
    isLoading,
    error,

...
import { useGetCustomersListSellerQuery } from "@/redux/services/seller/sellerCustomerReviews";
import {
...
} from "@/redux/services/seller/sellerCouponApis";
...
const AddCoupon = ({
  ...
  const { data: customersData } = useGetCustomersListSellerQuery({});
  const {
    data: categoriesData,
  ...
  console.log(categoriesData, subCategoriesData, subSubCategoriesData, "ccc");

  const [createCupon] = useCreateCuponSellerMutation();

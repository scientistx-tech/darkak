...
import { useGetAllRefundedRefundRequestSellerQuery } from "@/redux/services/seller/sellerRefundRequest";
...
const RefundedRefundRequest = () => {
  ...
  console.log("refunded data", data?.refund);
...
export default RefundedRefundRequest;

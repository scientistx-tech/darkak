...
import { useGetAllRefundRequestSellerQuery } from "@/redux/services/seller/sellerRefundRequest";
...
const PendingRefundRequest = () => {
  ...
  const { data, isFetching, isLoading } = useGetAllRefundRequestSellerQuery({});

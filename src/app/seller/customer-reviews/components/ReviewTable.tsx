...
import { useChangeCustomerReviewStatusSellerMutation } from "@/redux/services/seller/sellerCustomerReviews";
...
export const ReviewTable: React.FC<ReviewTableProps> = ({
  ...
  const [changeReviewStatus] = useChangeCustomerReviewStatusSellerMutation();
  return (
